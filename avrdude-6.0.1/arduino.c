...
{
	fprintf(stderr, "\n [type=Arduino] arduino_read_sig_bytes \n");
  ...
  fprintf(stderr, "\n [type=Arduino] arduino_read_sig_bytes %2X %2X %2X DONE. \n", buf[1], buf[2], buf[3]);
