...
static void usage(void)
{
 ...
 "  -?                         Display this usage.\n\n"
 " -----------  MODIFIED BY SUJEET ----------\n"
		  " - Added Support for extended parameters"
...
int main(int argc, char * argv [])
{
  ...
  /*
   * Sujeet:
   * We have well-defined set of PROGRAMMER_TYPEs (pgm_type.c)
   * Now, we want the instance of the PROGRAMMER
   *
   */
  ...
  /*
   * Sujeet: This will internally call stk500->init
   */
  ...
  for (ln=lfirst(updates); ln; ln=lnext(ln)) {
    ...
    /*
     * This is where the pgm pages get written.
     */
